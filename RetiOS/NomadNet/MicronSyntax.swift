...
private struct MicronScanner {
  ...
  private mutating func run() {
    ...
    if let fence = literalFence {
      diagnose(
        .error, fence.range, line: fence.line,
