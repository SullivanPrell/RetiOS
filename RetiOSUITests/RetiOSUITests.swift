...
final class RetiOSUITests: XCTestCase {
  ...
  func testRNodeScreenIsReachableFromPreferencesScene() {
    ...
    XCTAssertTrue(
      interfaces.waitForExistence(timeout: 20),
