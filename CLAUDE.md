...
The caution that used to sit here—"confirm before running, this is not a git repo"—described
the *session root*, which is not a repo; this directory is one. It was read as a
