...
final class RNSDateTests: XCTestCase {
  ...
  func testWithinTheLastWeekShowsWeekday() {
    ...
    XCTAssertEqual(
      RNSDate.listTimestamp(threeDaysAgo, now: now),
  ...
  func testOlderThanAWeekShowsDate() {
    ...
    XCTAssertEqual(
      RNSDate.listTimestamp(longAgo, now: now),
  ...
  func testSevenDaysAgoIsADateNotAWeekday() {
    ...
    XCTAssertEqual(
      RNSDate.listTimestamp(sevenDaysAgo, now: now),
  ...
  func testAgoReadsAsElapsedTime() {
    ...
    XCTAssertTrue(
      out.lowercased().contains("hour") || out.lowercased().contains("ago"),
